...
- **Plugin development** merged with **Machine learning** and **Deep learning**, especially vst instrument creation as I did in two of my project the [Handmonizer, an artist oriented vocal harmonizer](https://github.com/EllDy96/Handmonizer) and the [handy fm synthetizer](https://github.com/EllDy96/ComputerMusicProjects/tree/Homework3).
